...
/// <summary>
/// Ported from HexManiac.WPF/Controls/AngleBorder.xaml(.cs).
...
/// </summary>
public class AngleBorder : ContentControl {

   #region AngleDirection

   public static readonly StyledProperty<AngleDirection> DirectionProperty =
      AvaloniaProperty.Register<AngleBorder, AngleDirection>(nameof(Direction), AngleDirection.None);
   ...
   public static readonly StyledProperty<Point> LeftTopProperty =
      AvaloniaProperty.Register<AngleBorder, Point>(nameof(LeftTop), new Point(0, 0));
   ...
   public static readonly StyledProperty<Point> LeftMiddleProperty =
      AvaloniaProperty.Register<AngleBorder, Point>(nameof(LeftMiddle), new Point(0, 5));
   ...
   public static readonly StyledProperty<Point> LeftBottomProperty =
      AvaloniaProperty.Register<AngleBorder, Point>(nameof(LeftBottom), new Point(0, 10));
   ...
   public static readonly StyledProperty<Point> RightTopProperty =
      AvaloniaProperty.Register<AngleBorder, Point>(nameof(RightTop), new Point(0, 0));
   ...
   public static readonly StyledProperty<Point> RightMiddleProperty =
      AvaloniaProperty.Register<AngleBorder, Point>(nameof(RightMiddle), new Point(0, 5));
   ...
   public static readonly StyledProperty<Point> RightBottomProperty =
      AvaloniaProperty.Register<AngleBorder, Point>(nameof(RightBottom), new Point(0, 10));
