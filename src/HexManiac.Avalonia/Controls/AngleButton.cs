...
/// <summary>
/// Ported from HexManiac.WPF/Controls/AngleButton.xaml(.cs).
...
/// </summary>
public class AngleButton : ToggleButton {

   #region AngleDirection

   public static readonly StyledProperty<AngleDirection> DirectionProperty =
      AvaloniaProperty.Register<AngleButton, AngleDirection>(nameof(Direction), AngleDirection.None);
   ...
   public static readonly StyledProperty<Point> LeftTopProperty =
      AvaloniaProperty.Register<AngleButton, Point>(nameof(LeftTop), new Point(0, 0));
   ...
   public static readonly StyledProperty<Point> LeftMiddleProperty =
      AvaloniaProperty.Register<AngleButton, Point>(nameof(LeftMiddle), new Point(0, 5));
   ...
   public static readonly StyledProperty<Point> LeftBottomProperty =
      AvaloniaProperty.Register<AngleButton, Point>(nameof(LeftBottom), new Point(0, 10));
   ...
   public static readonly StyledProperty<Point> RightTopProperty =
      AvaloniaProperty.Register<AngleButton, Point>(nameof(RightTop), new Point(0, 0));
   ...
   public static readonly StyledProperty<Point> RightMiddleProperty =
      AvaloniaProperty.Register<AngleButton, Point>(nameof(RightMiddle), new Point(0, 5));
   ...
   public static readonly StyledProperty<Point> RightBottomProperty =
      AvaloniaProperty.Register<AngleButton, Point>(nameof(RightBottom), new Point(0, 10));
